...
```
style/
├── FE-CREDIT-style-guide.md      # Main style guide document
└── README.md                     # This file
```
...
2. Follow the format of the FE-CREDIT guide for consistency
3. Include sections for brand, colors, typography, components, and best practices
